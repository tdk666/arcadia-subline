...
export const en: Dict = {
  ...
  ftue: {
    ...
    revealCta: 'Continue',
    conquest: 'Station conquered!',
    conquestSub: 'Louvre-Rivoli joins your line.',
    epilogue: 'Now conquer Paris.',
    epilogueSub: 'Your first station awaits on the map.',
    cta: 'Continue — no account',
  },
  demo: {
  ...
  map: {
    ...
    heroCta: 'Storm it',
    tapHint: 'Tap a station to play — no need to be there.',
  },
  station: {
