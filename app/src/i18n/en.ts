...
export const en: Dict = {
  ...
  ftue: {
    ...
    t0Tap: 'tap to enter',
    t0LookUp: 'Look up',
    t1Orient: 'Paris. The metro is your board. Every station, a game.',
    t1Cta: 'Take Bastille',
    t2Tap: 'tap to bring down the Bastille',
    t2Liberated: 'BASTILLE — LIBERATED',
    t2FlashQ: 'Is it a revolt?',
    t2FlashA: 'No, Sire… it is a revolution.',
    t2FlashTag: 'TRADITION · 14 JULY 1789',
    t2Countable: '1 station taken. The line awaits.',
    t2Continue: 'continue',
    t2Archive: 'Palloy resold its stones as relics.',
    t2ArchiveCta: 'Archive',
    t3Scale: 'From Station Chief to Emperor of Paris',
    t3Apex: 'EMPEROR OF PARIS',
    t3Locked: 'to be earned',
    t3Flame: 'Day 1',
    t3NextLabel: 'next',
    t3Go: 'Follow the line',
  },
  demo: {
